...
#### Commercial cryptocurrency data:
* [Kaiko](https://www.kaiko.com/)
* [CryptoCompare](https://www.cryptocompare.com/)
* [TheCrix](https://thecrix.de/)

#### DEX data:
* [Bitquery](https://bitquery.io/)
* [DuneAnalytics](https://dune.xyz/)

#### Economic data:
* [Federal Reserve Economic Data (FRED)](https://fred.stlouisfed.org/)

#### Free cryptocurrency data:
* [Bitcoinity](https://data.bitcoinity.org)
...
#### Bitcoin:
* [Bitcointalk.org Forum](https://bitcointalk.org/)
* [Bitcoin White Paper](https://bitcoin.org/bitcoin.pdf)
* [Bitcoin Wiki](https://en.bitcoin.it/wiki/Main_Page)
* [Jameson Lopp's Website](https://www.lopp.net/)
...
* [Wei Dai Website](http://www.weidai.com/)

#### DeFi:
* [DeFi Pulse](https://defipulse.com/)
* [List of Historic DeFi Attacks](https://preventflashloanattacks.com/)
...
* [Etheplorer: Ethereum Tokens Explorer](https://ethplorer.io/)
* [EthStats](https://ethstats.net/)
* [Historical Sources of the White Paper](https://github.com/ethereum/wiki/blob/old-before-deleting-all-files-go-to-wiki-wiki-instead/old-whitepaper-for-historical-reference.md)
* [GasToken](https://gastoken.io/)
* [Learning by coding](https://ethereum.org/en/developers/learning-tools/)
* [LibSubmarine: Defeat Front-Running on Ethereum](https://libsubmarine.org/)
* [Solidity by Example](https://solidity-by-example.org/)
* [The Ethereum Research Forum](https://ethresear.ch/)
...
Media:
* [Playlist with Ethereum Core Dev Meetings](https://www.youtube.com/playlist?list=PLaM7G4Llrb7zfMXCZVEXEABT8OSnd4-7w)

MEV:
* [Ethereum Docs: MEV](https://ethereum.org/en/developers/docs/mev/)
* [Flashbots](https://github.com/flashbots/pm)
* [MEV Explore](https://explore.flashbots.net/)
* [Paradigm Research: MEV](https://research.paradigm.xyz/MEV)

Smart contract development:
* [Brownie](https://github.com/eth-brownie/brownie)
* [DappSys](https://github.com/dapphub/dappsys)
* [EthFiddle Web IDE](https://ethfiddle.com/)
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts)
* [Remix Web IDE](https://remix.ethereum.org/)
* [Waffle](https://github.com/EthWorks/Waffle)

#### Hashcash:
* [Adam Back's Website](http://cypherspace.org/adam/)
* [Cypherspace.org](http://cypherspace.org/)
* [Hashcash](http://www.hashcash.org/)

#### Misc.:
* [Tim May's 1994 The Cyphernomicon](https://nakamotoinstitute.org/static/docs/cyphernomicon.txt)
...
* [BlockchainStuff](https://github.com/Xel/Blockchain-stuff)
* [Campbell Harvey Course Resources](https://faculty.fuqua.duke.edu/~charvey/Teaching/697_2019/697_Syllabus.htm)
* [Crypto Market Pool](https://cryptomarketpool.com/)
* [List of Decentralized Exchanges](https://github.com/distribuyed/index/blob/master/README.md)
* [Satoshi Nakamoto Institute](https://nakamotoinstitute.org/)
* [Satoshi Nakamoto Institute Literature](https://nakamotoinstitute.org/literature/)

## GNU/Linux

#### Configuration
* [Terminal colors](https://terminal.sexy/)
* [Prompt generator](https://ezprompt.net/)
...
* [List of programming languages by type](https://en.wikipedia.org/wiki/List_of_programming_languages_by_type#Curly-bracket_languages)
